...
class Chemin:
   ...
   def swap(self,cheminPos1, cheminPos2):     
       self.setNoeud(cheminPos2, self.getNoeud(cheminPos1))
       self.setNoeud(cheminPos1, self.getNoeud(cheminPos2))
   ...
   def removeNones(self):
        newChemin = [chemin for chemin in self.chemin if chemin is not None]
